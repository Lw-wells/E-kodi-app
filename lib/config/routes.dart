...
class AppRoutes {
  ...
  static const String addProperty = '/properties/add'; // ✅ must come before propertyDetail
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return AssignTenantScreen(propertyId: propertyId, unitId: unitId, unitName: unitName);
        },
      ),
