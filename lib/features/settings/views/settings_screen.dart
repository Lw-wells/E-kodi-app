    ...
    try {
      ...
      if (doc.exists) {
        ...
        setState(() {
          ...
          _currency = data['currency'] as String? ?? 'KES';
          _defaultRent = (data['defaultRent'] as num?)?.toDouble() ?? 0;
          _rentReminders = data['rentReminders'] as bool? ?? true;
          _paymentAlerts = data['paymentAlerts'] as bool? ?? true;
          _maintenanceAlerts = data['maintenanceAlerts'] as bool? ?? true;
        });
      }
    } catch (e) {
      if (mounted) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              initialValue: _defaultRent > 0
                  ? _defaultRent.toStringAsFixed(0)
                  : '',
              decoration: const InputDecoration(
                labelText: 'Default Rent Amount',
                prefixIcon: Icon(Icons.home),
                border: OutlineInputBorder(),
                helperText: 'Applied to new units by default',
              ),
              keyboardType: TextInputType.number,
              onChanged: (v) =>
                  setState(() => _defaultRent = double.tryParse(v) ?? 0),
            ),
          ],
        ),
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            SwitchListTile(
              ...
              subtitle: const Text('Get notified when tenants pay'),
            ...
            SwitchListTile(
              ...
              subtitle: const Text('Get notified of maintenance requests'),
